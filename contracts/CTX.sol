...
{
/// Fields:
    string public constant name = "Cartaxi Presale Token";
    string public constant symbol = "CTX";
    uint public constant decimals = 18;
    uint public constant PRICE = 4101;  // per 1 Ether

    //  price
    // Cap is 3048 ETH
    // 1 eth = 4101;  presale CTX tokens
    uint public constant TOKEN_SUPPLY_LIMIT = PRICE * 3048 * (1 ether / 1 wei);
